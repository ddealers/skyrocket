			...
			scenes:[
				{
					...
					containers:[
						...
						{type: 'ldrg', id: 'ldrg5', x: 120, y: 270, index: 'black and white', text: 'black and white', target: ['pcpt1','pcpt2','pcpt3','pcpt4','pcpt5','pcpt6','pcpt7','pcpt8'], font: 'Bold 18px Quicksand', afterSuccess:'origin', afterFail:'return', eval: @onDrop}
