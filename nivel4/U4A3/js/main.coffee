...
class U4A3 extends Oda
	constructor: ->
		@manifest = [
			{id:'bike', src:'bike.png'}
			{id:'buttons', src:'buttons.png'}
			{id:'cat', src:'cat.png'}
			{id:'c2', src:'circulo2.png'}
			{id:'c1', src:'cirulo1.png'}
			{id:'clock', src:'clock.png'}
			{id:'computer', src:'computer.png'}
			{id:'cook', src:'cook.png'}
			{id:'count', src:'count.png'}
			{id:'drawing', src:'drawing.png'}
			{id:'header', src:'header.png'}
			{id:'onefoot', src:'one_foot.png'}
			{id:'pantalla01', src:'pantalla-01.png'}
			{id:'mozart', src:'piano.png'}
			{id:'reading', src:'reading.png'}
			{id:'scissors', src:'scissors.png'}
			{id:'tabletbaby', src:'tabletbaby.png'}
			{id:'walk', src:'walk.png'}
			{id:'write', src:'write.png'}
			...
			scenes:[
				{
					answers: {
						collection: [
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'onefoot'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'count1btn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'cookbtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'standbtn'}}
								{name: 'pcpt1', opts:{pattern:['When I was 3, I could ', '#tcpt', 'on one foot.'], targets: [{text:'stand'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'count'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'count2btn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'turnonbtn'}}
								{name: 'pcpt1', opts:{pattern:['Bruno learned to', '#tcpt', 'to 10 when he was 5 years old.'], targets: [{text:'count'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'mozart'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'cookbtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'standbtn'}}
							...
							[
								...
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'cookbtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'count3btn'}}
								{name: 'pcpt1', opts:{pattern:['My brother could', '#tcpt', 'breakfast when he was 10 years old.'], targets: [{text:'cook'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'buttons'}}
							...
							[
								...
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'count2btn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'turnonbtn'}}
								{name: 'pcpt1', opts:{pattern:['Mike could', '#tcpt', 'a computer when he was 5 years old.'], targets: [{text:'turn on'}]}}
							]
							
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'drawing'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'drawbtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'standbtn'}}
								{name: 'pcpt1', opts:{pattern:['Julie could', '#tcpt', 'pictures of her friends when she was 9 years old.'], targets: [{text:'draw'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'bike'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'cookbtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'ridebtn'}}
								{name: 'pcpt1', opts:{pattern:['Leo could', '#tcpt', 'a bike when he was 6 years old.'], targets: [{text:'ride'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'tabletbaby'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'writebtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'paintbtn'}}
								{name: 'pcpt1', opts:{pattern:['Pete could', '#tcpt', 'computer games when he was 1 year old!'], targets: [{text:'play'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'reading'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'readbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'count2btn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'paintbtn'}}
								{name: 'pcpt1', opts:{pattern:['Fiona could', '#tcpt', 'a book when she was 4 years old.'], targets: [{text:'read'}]}}
							]
							[
							...
							[
								...
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'playbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'writebtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'singbtn'}}
								{name: 'pcpt1', opts:{pattern:['Alex could', '#tcpt', 'his name when he was 4.'], targets: [{text:'write'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'clock'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'readbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'writebtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'tellbtn'}}
								{name: 'pcpt1', opts:{pattern:['Alex could', '#tcpt', 'the time when he was 7 years old.'], targets: [{text:'tell'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'scissors'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'readbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'writebtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'usebtn'}}
								{name: 'pcpt1', opts:{pattern:['Andy could', '#tcpt', 'a pair of scissors when she was 6 years old.'], targets: [{text:'use'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'walk'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target:  'walkbtn'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target:  'cookbtn'}}
								{name: 'grpder', opts:{type: 'fadeIn', target:  'singbtn'}}
								{name: 'pcpt1', opts:{pattern:['Benjamin could', '#tcpt', 'when he was 11 months old!'], targets: [{text:'walk'}]}}
							]
					...
					containers:[
						{type: 'img',  id:'bike' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'buttons' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'cat' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'clock' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'computer' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'cook' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'count' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'drawing' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'onefoot' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'mozart' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'reading' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'scissors' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'tabletbaby' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'walk' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'write' , x: 400, y: 308, align: 'mc'}

						{type: 'pcpt', id: 'pcpt1', x: 475, y: 540, font: 'Bold 20px Quicksand', margin: 5, align: 'tc', scolor: '#005da2', uwidth: 90}
