      ...
      scenes:[
        ...
        }
        {
          ...
          containers:[
            ...
            {type: "ldrg", id: "ldrb5", x: 140, y: 500, index: "Jim", text: "Jim", font: "26px Quicksand", color: "#333", target: ["b1", "b2", "b3", "b4", "b5"], eval: @evaluateDrop, afterSuccess: "hide", afterFail: "return"}
            {type: "ldrg", id: "ldrb3", x: 245, y: 500, index: "Simon", text: "Simon", font: "26px Quicksand", color: "#333", target: ["b1", "b2", "b3", "b4", "b5"], eval: @evaluateDrop, afterSuccess: "hide", afterFail: "return"}
            {type: "ldrg", id: "ldrb4", x: 375, y: 500, index: "Kris", text: "Kris", font: "26px Quicksand", color: "#333", target: ["b1", "b2", "b3", "b4", "b5"], eval: @evaluateDrop, afterSuccess: "hide", afterFail: "return"}
            {type: "ldrg", id: "ldrb1", x: 485, y: 500, index: "Frank", text: "Frank", font: "26px Quicksand", color: "#333", target: ["b1", "b2", "b3", "b4", "b5"], eval: @evaluateDrop, afterSuccess: "hide", afterFail: "return"}
            {type: "ldrg", id: "ldrb2", x: 620, y: 500, index: "Dirk", text: "Dirk", font: "26px Quicksand", color: "#333", target: ["b1", "b2", "b3", "b4", "b5"], eval: @evaluateDrop, afterSuccess: "hide", afterFail: "return"}
            {
              type: "btn", id: "repeat", x: 740, y: 540, isRepeat: true
              states: [img: {name: "repeat", x: 0, y: 0, align: "mc"}]
            }
