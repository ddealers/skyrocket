                ...
                [
                  {
                    name: 'lbl1',
                    opts: {
                      text: 'She used to go to school when she was a child.',
                      success: false
                    }
                  }
                ], [
                  {
                    name: 'lbl1',
                    opts: {
                      text: 'Her dad used to say girls and boys need to go to school.',
                      success: false
                    }
                  }
                ], [
                  {
                    name: 'lbl1',
                    opts: {
                      text: 'She used to work during the day and study at nights.',
                      success: true
                    }
                  }
                ], [
                  {
                    name: 'lbl1',
                    opts: {
                      text: 'She used to go dancing a lot.',
                      success: true
                    }
                  }
                ]
                ...
                [
                  {
                    name: 'lbl2',
                    opts: {
                      text: 'Pete started working when he was 12.',
                      success: true
                    }
                  }
                ], [
                  {
                    name: 'lbl2',
                    opts: {
                      text: 'He used to tell his granddaughter to get a job.',
                      success: false
                    }
                  }
                ], [
                  {
                    name: 'lbl2',
                    opts: {
                      text: 'He used to wash in a cold bathroom.',
                      success: false
                    }
                  }
                ], [
                  {
                    name: 'lbl2',
                    opts: {
                      text: 'He used to work on his parents\' farm and in a factory.',
                      success: true
                    }
                  }
                ]
                ...
                [
                  {
                    name: 'lbl3',
                    opts: {
                      text: 'People used to listen to the radio or records in the \'60s.',
                      success: true
                    }
                  }
                ], [
                  {
                    name: 'lbl3',
                    opts: {
                      text: 'Everybody had a color television.',
                      success: false
                    }
                  }
                ], [
                  {
                    name: 'lbl3',
                    opts: {
                      text: 'Telegrams were written on computers.',
                      success: false
                    }
                  }
                ], [
                  {
                    name: 'lbl3',
                    opts: {
                      text: 'People washed their clothes by hand.',
                      success: true
                    }
                  }
                ]
