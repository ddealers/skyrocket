...
class U8A4 extends Oda
	constructor: ->
		@manifest = [
			...
			{id:'drown', src:'drown.png'}
			{id:'invisible', src:'invisible.png'}
			{id:'kidnapped', src:'kidnapped.png'}
			{id:'kitten', src:'kitten.png'}
			{id:'pantalla', src:'pantalla-01.png'}
			{id:'telepathy', src:'telepathy.png'}
			{id:'thieves', src:'thieves.png'}
			{id:'wind', src:'wind.png'}
			...
			scenes:[
				{
					answers: {
						collection: [
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'thieves'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'aregoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'arentgoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isntgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['The thieves','#tcpt','to escape!','#rtn','Ms. Strongarms is running after them.'], targets: [{text:'aren\'t going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'thieves'}}
							...
							[
								...
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'isgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'aregoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'arentgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['Dr. Invisible','#tcpt','surprise the bad men.'], targets: [{text:'is going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'telepathy'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'aregoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'isntgoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['This man','#tcpt','know what the girl is thinking.'], targets: [{text:'is going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'kidnapped'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'isntgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'isgoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isgoing3'}}
								{name: 'pcpt1', opts:{pattern:['Dr. X-ray','#tcpt','find the woman.'], targets: [{text:'is going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'drown'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'isntgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'isgoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isgoing3'}}
								{name: 'pcpt1', opts:{pattern:['Ms. Ice','#tcpt','help the boy in the river.'], targets: [{text:'is going to'}]}}
							]
							
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'bridge'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'arentgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'aregoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['The cars','#tcpt','fall from the bridge, ','#rtn','because Dr. Electric is helping them!'], targets: [{text:'aren\'t going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'bridge'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'isgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'aregoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isntgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['Dr. Electric and his assistant','#tcpt','fix the bridge.'], targets: [{text:'are going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'kitten'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'isgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'aregoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isntgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['Ms. Bluewings','#tcpt','save a dog.'], targets: [{text:'isn\'t going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'kitten'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'arentgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'aregoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isgoingto3'}}
								{name: 'pcpt1', opts:{pattern:['Ms. Bluewings','#tcpt','save a kitten.'], targets: [{text:'is going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'wind'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'isntgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'isgoingto2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'isgoing3'}}
								{name: 'pcpt1', opts:{pattern:['This superhero changes the weather.','#rtn','He','#tcpt','make the sun shine.'], targets: [{text:'is going to'}]}}
							]
							[
								{name: 'grp1', opts:{type: 'fadeIn', target: 'wind'}}
								{name: 'grpizq', opts:{type: 'fadeIn', target: 'arentgoingto'}}
								{name: 'grpmid', opts:{type: 'fadeIn', target: 'aregoing2'}}
								{name: 'grpder', opts:{type: 'fadeIn', target: 'aregoingto3'}}
								{name: 'pcpt1', opts:{pattern:['The vegetables','#tcpt','grow because the sun will shine.'], targets: [{text:'are going to'}]}}
							]
					...
					containers:[
						{type: 'img',  id:'bridge' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'drown' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'invisible' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'kidnapped' , x: 400, y: 308, align: 'mc'}
						{type: 'img',  id:'kitten' , x: 400, y: 308, align: 'mc'}
