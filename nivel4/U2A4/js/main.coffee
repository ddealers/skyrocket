...
class U2A4 extends Oda
	constructor: ->
		@manifest = [
			...
			{id:'step1', src: 'step-01.png'}
			{id:'step2', src: 'step-02.png'}
			{id:'step3', src: 'step-03.png'}
			{id:'step4', src: 'step-04.png'}
			{id:'step5', src: 'step-05.png'}
			{id:'step6', src: 'step-06.png'}
			{id:'step7', src: 'step-07.png'}
			{id:'step8', src: 'step-08.png'}
			{id:'step9', src: 'step-09.png'}
			{id:'step10', src: 'step-10.png'}
			{id:'step11', src: 'step-11.png'}
					...
					containers:[
						{
							...
							frames: [[0,0,554,311,0,277,155.5],[0,0,554,311,1,277,155.5],[0,0,554,311,2,277,155.5],[0,0,554,311,3,277,155.5],[0,0,554,311,4,277,155.5],[0,0,554,311,5,277,155.5],[0,0,554,311,6,277,155.5],[0,0,554,311,7,277,155.5],[0,0,554,311,8,277,155.5],[0,0,554,311,9,277,155.5],[0,0,554,311,10,277,155.5]]
