					...
					answers: {
						collection: [
							...
							[
								...
								{name: 'wcpt1', opts:{word:'The Argentinean team||jumped||higher||than the Polish team', maxlength: 'than the Polish team', target: 't4', sentence: true}}
							]
							[
								{name: 'grp1', opts:{type: 'blink', target: 't5'}}
								{name: 'wcpt1', opts:{word:'The Argentinean||team got||more baskets||than the Poles', maxlength: 'than the Poles', target: 't5', sentence: true}}
							]
							[
					...
					groups: [
						{
							...
							type: 'grp', id: 'grp1', invisible:false
							group: [
								't1'
								't2'
								't3'
