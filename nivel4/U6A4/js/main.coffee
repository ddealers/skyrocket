		...
		@game = 
			...
			scenes:[
				...
				}
				{
					...
					containers:[
						{type: 'img', id:'foto', name: 'act4_2', x: 420, y: 210}
						...
						{type: 'lbl', id: 'lbl2', x: 400, y: 490, font: 'Bold 20px Quicksand', lineWidth:600, color: '#333', align: 'center'}
					]
					groups:[]
				}
				{
					...
					containers:[
						{type: 'img', id:'foto', name: 'act4_3', x: 420, y: 210}
						...
						{type: 'lbl', id: 'lbl3', x: 400, y: 490, font: 'Bold 20px Quicksand', lineWidth:600, color: '#333', align: 'center'}
					]
					groups:[]
				}
				{
					...
					containers:[
						{type: 'img', id:'foto', name: 'act4_4', x: 420, y: 210}
						...
						{type: 'lbl', id: 'lbl4', x: 400, y: 490, font: 'Bold 20px Quicksand', lineWidth:600, color: '#333', align: 'center'}
					]
					groups:[]
				}
			]
