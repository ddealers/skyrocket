...
class U4A4 extends Oda
	constructor: ->
		...
		@game = 
			header: 'header'
			instructions: {x: 110, y: 140, states: [{text:'Read the text. Then answer the questions, click on True or False.', sound:'s/silence', played: false}]}
			...
			scenes:[
				...
				}
				{
					...
					containers:[
						{type: 'img', id:'dance', name: 'dance', x: 420, y: 230}
						{type: 'txt', id: 't2', text:'Do you learn by moving your body? Come to our dance class on Monday, Wednesday and Friday mornings from 3 to 6 p.m. Please wear comfortable clothes and wash your feet before class!', x: 70, y: 260, lineWidth: 330, font:'14px Quicksand', align: 'left'}
						{
				...
				}
				{
					...
					containers:[
						{type: 'img', id:'nature', name: 'nature', x: 420, y: 230}
				...
				}
				{
					...
					containers:[
						{type: 'img', id:'musical', name: 'musical', x: 420, y: 230}
				...
				}
				{
					...
					containers:[
						{type: 'img', id:'course', name: 'course', x: 420, y: 230}
						{type: 'txt', id: 't5', text:'If reading makes you happy, come to our reading techniques class. Learn how to speed-read and make word maps. When you speed-read, you read faster and understand the text well. We have great stories for you to read!', x: 70, y: 260, lineWidth: 330, font:'14px Quicksand', align: 'left'}
						{
